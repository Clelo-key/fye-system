...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.fye.boot";
    private static final String ARTIFACT_ID = "fye";
    private static final String PACKAGE_NAME = "cn.fye.boot";
    private static final String TITLE = "FYE校园点评";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.fye.boot";
        String artifactIdNew = "fye";
        String packageNameNew = "cn.fye.lecteste";
        String titleNew = "FYE校园点评";
